...
class SpellContextResolveMixin(_SpellContextResolveBase):
    UTILITY_SPELL_CONTEXT_META: dict[str, dict] = {
        ...
        "ensnaring_strike": {
            "type": "weapon_hit_rider",
            "subtype": "ensnaring_strike",
            "requiresTarget": False,
            "requiresConcentration": True,
            "durationSeconds": 60,
            "trigger": "next_weapon_hit",
            "consumeOn": "weapon_hit",
            "weaponAttackOnly": True,
            "saveAbility": "strength",
            "saveEffect": "negates",
            "largeOrLargerSaveAdvantage": True,
            ...
            "escapeCheckAgainstSpellSaveDC": True,
            "outOfCombatCastable": False,
        },
        "hail_of_thorns": {
            "type": "weapon_hit_rider",
            "subtype": "hail_of_thorns",
            "requiresTarget": False,
            "requiresConcentration": True,
            "durationSeconds": 60,
            "trigger": "next_weapon_hit",
        ...
        "entangle": {
            ...
            "areaSizeMeters": 6,
            "areaSizeFeet": 20,
            "initialSaveAbility": "strength",
            "appliesConditionOnFailedSave": True,
            "conditionApplied": "restrained",
            "createsPersistentArea": True,
            "createsDifficultTerrain": True,
            "difficultTerrain": True,
            "escapeAction": True,
            "escapeCheckAbility": "strength",
            "escapeCheckAgainstSpellSaveDC": True,
            "affectsCreaturesInAreaOnCastOnly": True,
            "affectsEnteringCreatures": False,
            "outOfCombatCastable": False,
        },
        "faerie_fire": {
            "type": "area_debuff",
            ...
            "areaShape": "cube",
            "sideMeters": 6,
            "initialSaveAbility": "dexterity",
            "appliesPersistentEffectOnFailedSave": True,
            "conditionApplied": "faerie_fire",
            "createsPersistentArea": False,
            "affectsCreaturesInAreaOnCastOnly": True,
            "affectsEnteringCreatures": False,
            "grantsAttackAdvantageAgainstTarget": True,
            "suppressesInvisibilityBenefit": True,
            "lightEmission": True,
            "lightType": "dim",
            "lightRadiusMeters": 3,
            "outOfCombatCastable": False,
        ...
        "sleep": {
            ...
            "areaShape": "sphere",
            "radiusMeters": 6,
            "usesHitPointPool": True,
            "basePoolDice": "5d8",
            "upcastAdditionalDice": "2d8",
            "poolOrdering": "current_hp_ascending",
            "appliesCondition": "unconscious",
            "noSavingThrow": True,
            "excludesCreatureTypes": ["undead"],
            "excludesCharmedImmune": True,
            "wakesOnDamage": True,
            "wakesOnAction": True,
            "outOfCombatCastable": False,
        },
        "create_or_destroy_water": {
            "type": "environment_utility",
            "subtype": "create_or_destroy_water",
            "requiresTarget": False,
            "requiresPoint": True,
            "requiresConcentration": False,
            "durationSeconds": 0,
            "instantaneous": True,
            "requiresEffectPayload": True,
            "variants": ["create_water", "destroy_water"],
            "baseGallons": 10,
            "baseLiters": 38,
            "additionalGallonsPerSlotAboveBase": 10,
            "additionalLitersPerSlotAboveBase": 38,
            "areaShape": "cube",
            "baseCubeSideMeters": 9,
            "additionalCubeSideMetersPerSlotAboveBase": 1.5,
            "supportsContainerMode": True,
            "supportsAreaMode": True,
            "extinguishesExposedFlames": True,
            "destroysFog": True,
            "outOfCombatCastable": True,
            "outOfCombatTarget": "environment",
        },
        "shatter": {
            "type": "area_damage",
            "subtype": "shatter",
            ...
            "saveEffect": "half_damage",
            "inorganicCreatureSaveDisadvantage": True,
            "inorganicMaterials": ["stone", "crystal", "metal"],
            "affectsNonmagicalObjects": True,
            "affectsUnwornUncarriedObjects": True,
            "objectDamageType": "thunder",
            "outOfCombatCastable": False,
        },
        "silent_image": {
            "type": "illusion",
            "subtype": "silent_image",
            "requiresTarget": False,
            "requiresPoint": True,
            "requiresConcentration": True,
            "durationSeconds": 600,
            ...
            "sideMeters": 4.5,
            "createsPersistentArea": True,
            "createsIllusion": True,
            "illusionKind": "visual_image",
            "purelyVisual": True,
            "producesSound": False,
            "producesSmell": False,
            "producesTemperature": False,
            "producesLight": False,
            "physicalInteractionReveals": True,
            "investigationCheck": True,
            "investigationAbility": "intelligence",
            "investigationSkill": "investigation",
            "investigationAgainstSpellSaveDC": True,
            "creatureCanSeeThroughAfterSuccess": True,
            "casterCanMoveOrAlterWithAction": True,
            "outOfCombatCastable": False,
        },
        "crown_of_madness": {
            "type": "control_debuff",
            "subtype": "crown_of_madness",
            "requiresTarget": True,
            "requiresConcentration": True,
            "durationSeconds": 60,
            "initialSaveAbility": "wisdom",
            "targetCreatureTypeRestriction": ["humanoid"],
            "appliesConditionOnFailedSave": True,
            "conditionApplied": "charmed",
            "appliesPersistentEffectOnFailedSave": True,
            "forcedActionControl": True,
            "forcedActionType": "melee_attack",
            "forcedActionTiming": "before_movement_on_target_turn",
            "forcedAttackTargetChosenByCaster": True,
            "forcedAttackCannotTargetSelf": True,
            "targetActsNormallyIfNoChosenTarget": True,
            "requiresCasterActionToMaintain": True,
        ...
        "sanctuary": {
            ...
            "durationSeconds": 60,
            "targetingGuard": True,
            "targetingGuardType": "sanctuary",
            "guardSaveAbility": "wisdom",
            "blocksDirectAttacks": True,
            "blocksDirectHostileSpells": True,
            "doesNotBlockAreaEffects": True,
            "supportsRetarget": True,
            "breaksOnAttack": True,
            "breaksOnOffensiveSpell": True,
            "breaksOnDamageDealt": True,
            "grantsACBonus": False,
            "grantsResistance": False,
            "outOfCombatCastable": True,
            "outOfCombatTarget": "self_or_ally",
        ...
        "warding_bond": {
            "type": "defense_buff",
            "subtype": "warding_bond",
            "requiresTarget": True,
            "requiresConcentration": False,
            "durationSeconds": 3600,
            "grantsACBonus": True,
            "armorClassBonus": 1,
            "grantsSavingThrowBonus": True,
            "savingThrowBonus": 1,
            "grantsResistance": True,
            "resistanceScope": "all_damage",
            "damageSharing": True,
            "damageShareTarget": "caster",
            "damageShareAmount": "final_damage_taken",
            "maxDistanceMeters": 18,
            "breaksIfCasterAtZeroHp": True,
            "breaksIfDistanceExceeded": True,
            "breaksIfRecastOnConnectedCreature": True,
            "outOfCombatCastable": True,
            "outOfCombatTarget": "self_or_ally",
        },
        "feather_fall": {
    ...
    _NARRATIVE_UTILITY_META_BY_SPELL: dict[str, dict] = {
        ...
        "purify_food_and_drink": {
            ...
            "purifiesFood": True,
            "purifiesDrink": True,
            "removesPoisonFromFoodAndDrink": True,
            "removesDiseaseFromFoodAndDrink": True,
            "affectsCreatures": False,
            "affectsMagicalFoodOrDrink": False,
        },
