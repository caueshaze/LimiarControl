...
_EXPLICIT_OVERRIDES: dict[str, SpellTargetingSemantics] = {
    ...
    "create_or_destroy_water": SpellTargetingSemantics("point", "selected_point", "selected_point", "none", "distance", "persistent"),
    ...
    "pass_without_trace": SpellTargetingSemantics("multi_creature", "caster", "selected_targets", "none", "distance", "persistent"),
    ...
    "moonbeam": SpellTargetingSemantics("point", "selected_point", "selected_point", "save", "distance", "persistent"),
}
