    ...
    for base_spell in base_spells:
        db.add(
            CampaignSpell(
                ...
                material_component_consumed=base_spell.material_component_consumed,
                consumable_material_options_json=base_spell.consumable_material_options_json,
                ...
                attack_miss_outcome=base_spell.attack_miss_outcome,
                ...
                requires_target_hearing=base_spell.requires_target_hearing,
