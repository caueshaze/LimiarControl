...
class TestPendingSaveModifierSources(unittest.IsolatedAsyncioTestCase):
    async def test_pending_save_uses_manual_gm_source_kind(self):
        ...
        with (
            ...
            patch(
                "app.services.combat_service.save_resolve.modify_saving_throw",
            ...
            await CombatService.resolve_pending_save(
                db,
        ...
        _, kwargs = spy_modify.call_args
        self.assertEqual(kwargs.get("source_kind"), "manual_gm")
