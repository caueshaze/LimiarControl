...
const SPELL_ADMIN_VALUE_LABELS: Record<string, LabelEntry> = {
  ...
  modify_weapon_damage: label("Modify weapon damage", "Modificar dano de arma"),
  ...
  advantage_on_saves: label("Advantage on saves", "Vantagem em salvaguardas"),
  disadvantage_on_saves: label("Disadvantage on saves", "Desvantagem em salvaguardas"),
  size_modifier: label("Size modifier", "Modificador de tamanho"),
  restrict_action: label("Restrict action", "Restringir ação"),
  caster: label("Caster", "Conjurador"),
  manual: label("Manual", "Manual"),
  rounds: label("Rounds", "Rodadas"),
  until_turn_start: label("Until turn start", "Até início do turno"),
  until_turn_end: label("Until turn end", "Até fim do turno"),
  timed: label("Timed", "Temporizado"),
  stack: label("Stack", "Acumular"),
  replace: label("Replace", "Substituir"),
  add: label("Add", "Somar"),
  subtract: label("Subtract", "Subtrair"),
  target: label("Target", "Alvo"),
  charmed: label("Charmed", "Encantado"),
  blinded: label("Blinded", "Cego"),
  deafened: label("Deafened", "Surdo"),
  frightened: label("Frightened", "Apavorado"),
  grappled: label("Grappled", "Agarrado"),
  hostile_to_caster: label("Hostile to caster", "Hostil ao conjurador"),
  incapacitated: label("Incapacitated", "Incapacitado"),
  invisible: label("Invisible", "Invisível"),
  paralyzed: label("Paralyzed", "Paralisado"),
  petrified: label("Petrified", "Petrificado"),
  poisoned: label("Poisoned", "Envenenado"),
  prone: label("Prone", "Derrubado"),
  restrained: label("Restrained", "Restringido"),
  stunned: label("Stunned", "Atordoado"),
  unconscious: label("Unconscious", "Inconsciente"),
  temp_ac_bonus: label("Temp AC bonus", "Bônus temporário de CA"),
  attack_bonus: label("Attack bonus", "Bônus de ataque"),
  damage_bonus: label("Damage bonus", "Bônus de dano"),
  actions: label("Actions", "Ações"),
  bonus_actions: label("Bonus actions", "Ações bônus"),
  reactions: label("Reactions", "Reações"),
  movement: label("Movement", "Movimento"),
  strength: label("Strength", "Força"),
  dexterity: label("Dexterity", "Destreza"),
  constitution: label("Constitution", "Constituição"),
  intelligence: label("Intelligence", "Inteligência"),
  wisdom: label("Wisdom", "Sabedoria"),
  charisma: label("Charisma", "Carisma"),
};
