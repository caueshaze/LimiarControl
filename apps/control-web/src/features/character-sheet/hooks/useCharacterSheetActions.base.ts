      ...
      return {
        ...
        spellcasting: {
          ...
          spells: [
            ...
            // legacy free-form entry — campaignSpellId is set only when the user
            // picks a catalog spell via selectCatalogSpell below.
            { id: nanoid(), name: "", level: 0, school: "Evocation", prepared: false, notes: "", campaignSpellId: null },
          ],
        },
      };
    });
