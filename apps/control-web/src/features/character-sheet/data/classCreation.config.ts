...
export const CLASS_CREATION_CONFIG: Record<string, ClassCreationConfig> = {
  ...
  guardian: {
    ...
    startingSpells: {
      ...
      leveledMode: "known",
      levelOneSlots: 2,
      fixedLeveledSpellCanonicalKeys: ["animal_friendship", "hunters_mark"],
      byLevel: {
        2:  { leveledSpells: 2,  levelOneSlots: 2 },
        3:  { leveledSpells: 3,  levelOneSlots: 3, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
        4:  { leveledSpells: 3,  levelOneSlots: 3, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
        5:  { leveledSpells: 4,  levelOneSlots: 4, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
        6:  { leveledSpells: 4,  levelOneSlots: 4, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
        7:  { leveledSpells: 5,  levelOneSlots: 4, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
        8:  { leveledSpells: 5,  levelOneSlots: 4, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
        9:  { leveledSpells: 6,  levelOneSlots: 4, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
        10: { leveledSpells: 6,  levelOneSlots: 4, fixedLeveledSpellCanonicalKeys: ["goodberry"] },
      },
    },
  },
  rogue: {
