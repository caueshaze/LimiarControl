  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050208] text-slate-100 selection:bg-limiar-400/25 selection:text-white">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.06] bg-[linear-gradient(rgba(255,255,255,0.18)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.18)_1px,transparent_1px)] bg-size-[72px_72px]" />
