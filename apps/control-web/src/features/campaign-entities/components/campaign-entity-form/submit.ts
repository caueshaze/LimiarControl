...
const sanitizeCombatActionForSubmit = (action: CombatAction): CombatAction | null => {
  ...
  const targetingRequirements = {
    requiresTargetSight: action.requiresTargetSight ?? null,
    requiresTargetEffect: action.requiresTargetEffect ?? null,
    requiresPointSight: action.requiresPointSight ?? null,
    requiresPointEffect: action.requiresPointEffect ?? null,
  };
