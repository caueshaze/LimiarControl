        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {campaignName && (
                <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-semibold text-slate-100">
                  {campaignName}
                </span>
              )}
