...
export const Skills = ({ className, abilities, skillProficiencies, level, onCycleProf, readOnly = false }: Props) => {
  ...
  return (
    <Section title="Skills" color="bg-cyan-500" className={className}>
...
const SkillRow = ({ skill, total, profLevel, abilityShort, onCycleProf, readOnly }: RowProps) => (
