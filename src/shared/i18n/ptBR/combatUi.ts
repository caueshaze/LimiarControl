export const combatUiPtBRDictionary = {
  ...
  "combatUi.useObjectHint": "No v1 isso funciona como um fluxo manual de combate. A ação é registrada no log sem consumir nem aplicar efeitos do item automaticamente.",
